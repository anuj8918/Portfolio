    ...
    <div id='about' className='text-white py-16 bg-[#0f0f2e]'>
      <div className='container mx-auto px-6 md:px-12 lg:px-24 text-center'>
        ...
        <div className='flex flex-col md:flex-row justify-center items-center'>
          ...
          >
            Hey, I'm <span className="text-purple-400 font-semibold">Anuj Mishra</span> — a 
            <span className="text-purple-400"> B.Tech IT student</span> and 
            <span className="text-purple-400"> MERN Stack Developer</span>.  
            Currently working as a <span className="text-purple-400">MERN Stack Developer Intern at Averybit Solutions</span>, 
            where I contribute to full-stack applications and RESTful APIs.  

            <br /><br />
            I have a strong foundation in <span className="text-purple-400">JavaScript, React, Node.js, Express, and MongoDB</span>.  
            Along with development, I’ve solved <span className="text-purple-400">250+ DSA problems</span> on LeetCode & GFG 
            and was a <span className="text-purple-400">National Hackathon Finalist (Top 6)</span>.  
          </motion.p>
        </div>
        ...
        <div className='flex flex-wrap justify-around items-center mt-12 gap-y-8'>
          ...
          >
            <h3 className='text-4xl md:text-6xl font-bold text-purple-500'>15+</h3>
            <p className='text-sm sm:text-base md:text-lg text-gray-300'>Technologies Mastered</p>
          </motion.div>
          ...
          <motion.div
            ...
            className='text-center px-4'
          >
            <h3 className='text-4xl md:text-6xl font-bold text-purple-500'>250+</h3>
            <p className='text-sm sm:text-base md:text-lg text-gray-300'>DSA Problems Solved</p>
          </motion.div>
          ...
          <motion.div
            ...
            className='text-center px-4'
          >
            <h3 className='text-4xl md:text-6xl font-bold text-purple-500'>6+</h3>
            <p className='text-sm sm:text-base md:text-lg text-gray-300'>Certifications Completed</p>
          </motion.div>
        </div>
      </div>
    </div>
